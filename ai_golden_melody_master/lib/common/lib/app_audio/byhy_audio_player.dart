...
class ByAudioPlayer {
  ...
  Future<bool> play(
    ...
    if (Platform.isAndroid) {
      await _audioPlayer.play(
          isPlaySource?DeviceFileSource(url):  UrlSource(url),
        position: position,
      );
    } else {
  ...
  ///设置音频播放资源
  Future<void> setSource(String url,{bool isFromServer = true,}) async {
    Get.log("url=====$url");
    if (Platform.isIOS) {
  ...
  ///设置音频播放资源
  Future<void> setSourceInterNet(String url) async {
    if (Platform.isIOS) {
