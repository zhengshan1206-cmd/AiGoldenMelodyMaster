...
class DownloadMusicDialog extends StatefulWidget {
  final MyWorksMusicItem musicItem;

  const DownloadMusicDialog({
    super.key,
    required this.musicItem,
  });

  @override
  State<DownloadMusicDialog> createState() => _DownloadMusicDialogState();
}

class _DownloadMusicDialogState extends State<DownloadMusicDialog> {
  ///定时器
  Timer? timer;
  ...
  startQuery() {
    Get.back();
    // EasyLoading.show(status: "正在下载中~",dismissOnTap:false);
          ...
          Row(
            ...
            children: [
              ...
              _itemView(
                ...
                name: "MP3文件",
                onTap: () async {
                  if (launchController.is90Vip || launchController.is30Vip||launchController.is365Vip) {
                    startQuery();
                  }else{
                    Get.back();
