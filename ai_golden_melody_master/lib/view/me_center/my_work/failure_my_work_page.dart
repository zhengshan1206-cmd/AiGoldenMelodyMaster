...
class FailureMyWorkPage extends StatefulWidget {
  const FailureMyWorkPage({super.key});

  @override
  State<FailureMyWorkPage> createState() => _FailureMyWorkPageState();
}

class _FailureMyWorkPageState extends State<FailureMyWorkPage>
    ...
    return GetBuilder<MyWorkController>(
      builder: (controller) {
        List<MyWorksMusicItem> failureMusicDataList =
            controller.failureMusicDataList;
        return Column(
          children: [
            Expanded(
              child: SmartRefresher(
                ...
                controller: controller.failureMusicDataController,
                onRefresh: controller.onRefresh,
                onLoading: controller.onLoading,
                child: failureMusicDataList.isEmpty
                  ...
                  children: [
                          ...failureMusicDataList
                              .map((e) => MyWorkItemView(musicItem: e,type: 3,)),
                        ],
                      ),
              ),
            )
